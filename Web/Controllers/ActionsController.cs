...
namespace Web.Controllers
{
	...
	public class ActionsController : ControllerBase
	{
		...
		public ActionsController(IConfiguration configuration, IStatusRepository adminRepository, IWebHostEnvironment webHostEnvironment)
		{
		...
		public async Task<IActionResult> GenerateTsFromSwagger()
		{
			...
			var path = Path.GetFullPath(Path.Join(webHostEnvironment.WebRootPath, "./scripts/autogeneratedServices.ts"));
